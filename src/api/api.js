...
export const getTags = params => { return axios.get(`${host}/tags`, {params: params})};
...
export const addCategorys = params => { return axios.post(`${host}/categorys/`, params) };
export const delCategorys = id => { return axios.delete(`${host}/categorys/${id}`+'/')};
export const addTags = params => { return axios.post(`${host}/tags/`, params) };
